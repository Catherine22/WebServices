...
public class CardListRVAdapter extends RecyclerView.Adapter<CardListRVAdapter.MainRvHolder> {
    private Context ctx;
    private List<TextCard> entities;
    private OnItemClickListener listener;
    private boolean fromHtml = false;

    public CardListRVAdapter(Context ctx, List<TextCard> entities, OnItemClickListener listener) {
        this.ctx = ctx;
    ...
    public MainRvHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new MainRvHolder(LayoutInflater.from(ctx).inflate(R.layout.rv_card_list, viewGroup, false));
    }
