    ...
    protected final void onCreateView(Bundle savedInstanceState) {
        ...
        if (isLazyLoad) {
            ...
            if (getUserVisibleHint() && !isInit) {
                ...
                View view = LayoutInflater.from(getApplicationContext()).inflate(R.layout.f_lazy_fragment, null);
                layout.addView(view);
...
//        CLog.d(TAG, "setUserVisibleHint() called with: " + "isVisibleToUser = [" + isVisibleToUser + "]");
...
//        CLog.d(TAG, "onStart() : " + "getUserVisibleHint():" + getUserVisibleHint());
        super.onStart();
    ...
    public final void onStop() {
        super.onStop();
//        CLog.d(TAG, "onStop() called: " + "getUserVisibleHint():" + getUserVisibleHint());
        if (isInit && isStart && getUserVisibleHint()) {
            isStart = false;
            onFragmentStopLazy();
        }
...
//        CLog.d(TAG, "onFragmentStartLazy() called with: " + "");
    }

    //当Fragment被滑到不可见的位置，offScreen时，调用
    protected void onFragmentStopLazy() {
//        CLog.d(TAG, "onFragmentStopLazy() called with: " + "");
    }

    protected void onCreateViewLazy(Bundle savedInstanceState) {
//        CLog.d(TAG, "onCreateViewLazy() called with: " + "savedInstanceState = [" + savedInstanceState + "]");
    }

    protected void onResumeLazy() {
//        CLog.d(TAG, "onResumeLazy() called with: " + "");
    }

    protected void onPauseLazy() {
//        CLog.d(TAG, "onPauseLazy() called with: " + "");
    }

    protected void onDestroyViewLazy() {
//        CLog.d(TAG, "onDestroyViewLazy() called with: " + "");
    }

    @Override
    @Deprecated
    public final void onResume() {
//        CLog.d(TAG, "onResume() : " + "getUserVisibleHint():" + getUserVisibleHint());
        super.onResume();
        if (isInit) {
            onResumeLazy();
        }
...
//        CLog.d(TAG, "onPause() : " + "getUserVisibleHint():" + getUserVisibleHint());
        super.onPause();
        if (isInit) {
            onPauseLazy();
        }
...
//        CLog.d(TAG, "onDestroyView() : " + "getUserVisibleHint():" + getUserVisibleHint());
        super.onDestroyView();
        if (isInit) {
            onDestroyViewLazy();
        }
