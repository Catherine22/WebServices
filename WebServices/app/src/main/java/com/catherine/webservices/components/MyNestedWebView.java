...
public class MyNestedWebView extends NestedWebView {
    private final static String TAG = "MyNestedWebView";
    private Context ctx;
    private WebViewProgressListener progressListener;

    public MyNestedWebView(Context context) {
        super(context);
        initSettings(context);
    }

    public MyNestedWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initSettings(context);
    }

    public MyNestedWebView(Context context, AttributeSet attrs, Context ctx) {
        super(context, attrs);
        initSettings(context);
    }

    public MyNestedWebView(Context context, AttributeSet attrs, int defStyleAttr, Context ctx) {
        super(context, attrs, defStyleAttr);
        initSettings(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MyNestedWebView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes, Context ctx) {
        super(context, attrs, defStyleAttr);
        initSettings(context);
    }
...
//                    context.startActivity(browserIntent);
            ...
            try {
                ...
                e.printStackTrace();
                DialogManager.showErrorDialog(ctx, "Failed to load URL", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        if (canGoBack())
                            goBack();
